    ...
    >
      ...
      >
        <LogoImage>
          ...
          >
            <img src="https://dr.ezzoom.us/wp-content/uploads/2021/10/cropped-logo_ezZoom-300x82.png" alt="" />
        ...
        {!isMobile && (
          ...
          >
            ...
            <Li>
              <Link href="#">
                <ALink href="#" title="Report abuse" fontSize={[14, 16]}>
                  Report
                </ALink>
              </Link>
            </Li>
      ...
      >
        <Li>
          <Flex display={["flex", "none"]}>
            <Link href="#">
              <ALink href="#" title="Report" fontSize={[14, 16]}>
                Report
              </ALink>
            </Link>
          </Flex>
